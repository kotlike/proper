...
function _getEventID(element) {
    _getEventID.id = _getEventID.id || 0; // have initial value not depending on the execution order
    if (element._xuiEventID) return element._xuiEventID;
    return element._xuiEventID = ++_getEventID.id;
}
// function may be called before we set this value or otherwise, hence this check
_getEventID.id = _getEventID.id || 0;
